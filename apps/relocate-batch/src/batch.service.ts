...
import { Member } from 'apps/relocate-api/src/libs/dto/member/member';
import { Property } from 'apps/relocate-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/relocate-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/relocate-api/src/libs/enums/property.enum';
